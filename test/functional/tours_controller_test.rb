...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { desp: @tour.desp, doj: @tour.doj, from_loc: @tour.from_loc, to_loc: @tour.to_loc, user_id: @tour.user_id }
    end
  ...
  test "should update tour" do
    put :update, id: @tour, tour: { desp: @tour.desp, doj: @tour.doj, from_loc: @tour.from_loc, to_loc: @tour.to_loc, user_id: @tour.user_id }
    assert_redirected_to tour_path(assigns(:tour))
  end
